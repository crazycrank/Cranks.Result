...
namespace Cranks.Result
{
    ...
    {
        /// <summary>
        /// Creates a new instance of <see cref="IResult"/> with <paramref name="successes"/> appended to <see cref="IReason.Reasons"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new instance of <see cref="IResult"/> with an instance of <typeparamref name="TSuccess"/> appended to <see cref="IReason.Reasons"/>.
        /// </summary>
        /// <param name="result">The source <see cref="IResult"/> object the returned object is based on.</param>
        ...
        /// <summary>
        /// Creates a new instance of <see cref="IResult{TValue}"/> with <paramref name="successes"/> appended to <see cref="IReason.Reasons"/>.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new instance of <see cref="IResult{TValue}"/> with an instance of <typeparamref name="TSuccess"/> appended to <see cref="IReason.Reasons"/>.
        /// </summary>
        /// <param name="result">The source <see cref="IResult{TValue}"/> object the returned object is based on.</param>
        /// <typeparam name="TValue">The <see cref="IResult{TValue}"/>s underlying result type.</typeparam>
        /// <typeparam name="TSuccess">Type of the <see cref="Success"/> to create.</typeparam>
