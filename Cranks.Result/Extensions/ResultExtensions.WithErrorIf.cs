...
namespace Cranks.Result
{
    public static partial class ResultExtensions
    {
        ...
        /// <summary>
        /// Creates a new <see cref="IResult"/> with <paramref name="errorFactory"/> added to <see cref="IReason.Causes"/> if <paramref name="condition"/> is true.
        /// </summary>
        /// <param name="result">The source <see cref="IResult"/> object the returned object is based on.</param>
        ...
        /// <returns>A new instance of <see cref="IResult"/> with the requested modifications.</returns>
        public static IResult WithErrorIf(this IResult result, bool condition, Func<Error> errorFactory)
            => condition ? result.WithError(errorFactory()) : result.Pass();

        /// <summary>
        /// Creates a new instance of <see cref="IResult"/> with <paramref name="errorFactory"/> added to <see cref="IReason.Causes"/> if <paramref name="condition"/> is true.
