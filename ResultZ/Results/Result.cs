...
namespace ResultZ
{
    public static class Result
    {
        ...
        public static IResult Pass(string message) => new Passed(message);
        ...
        public static IResult<TValue> Pass<TValue>(TValue value, string message) => new Passed<TValue>(value, message);
        ...
        public static IResult Fail(string message) => new Failed(message);
        ...
        public static IResult<TValue> Fail<TValue>(string message) => new Failed<TValue>(message);
